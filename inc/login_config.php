...
/*
define("DB_HOST", "50.63.146.240");
define("DB_NAME", "fairytal_pages");
define("DB_USER", "fairytal_main");
define("DB_PASS", "z@N]]tHwUyR=");
*/
...
define("COOKIE_DOMAIN", ".fairytaleyourparty.com");
define("COOKIE_SECRET_KEY", "{X`FGWc%<52x&6]Xh3v@m5");
...
define("EMAIL_SMTP_HOST", "ssl://smtp.gmail.com");
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "fun@fairytaleyourparty.com");
define("EMAIL_SMTP_PASSWORD", "m7W5373#jf9C%85z");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", "ssl");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", $webPath3);
define("EMAIL_PASSWORDRESET_FROM", "no-reply@fairytaleyourparty.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Fairytale Entertainment");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password Recovery");
 ...
 */
define("EMAIL_VERIFICATION_URL", $webPath3);
define("EMAIL_VERIFICATION_FROM", "no-reply@fairytaleyourparty.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Fairytale Playbook Registration");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Fairytale Playbook");
define("EMAIL_VERIFICATION_CONTENT", "Please click on this link to activate your account: \n");

/**
 * Configuration for: contact form email data
 */
define("EMAIL_CONTACT_FROM", "no-reply@fairytaleyourparty.com");
define("EMAIL_CONTACT_TO", "info@fairytaleyourparty.com");
define("EMAIL_CONTACT_FROM_NAME", "Fairytale Contact Us Form");
define("EMAIL_CONTACT_SUBJECT", "Message from Fairytale Contact Us Form");
