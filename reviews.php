...
<?php ?>
    <!--chooseReview Modal-->
<div class="container">
    <div class="chooseReview" id="" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
                        ...
                        <div class="col-sm-12" style="">
                            <div class="userFields">
                                <div class="col-xs-12 text-center">
                                    <a href="https://plus.google.com/107179780561536622263/about?gl=US&hl=en-US&review=1" target="_blank"><input type="button" class="btn btn-default" name="googleReview" id="googleReview" value="Google +"></a>
                                </div>
                                <div class="col-xs-12 text-center">
    ...
    <!--yourThoughts Modal-->
    <div class="yourThoughts" id="" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="doBetter" id="" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="customerInfo" id="" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!--starRating Modal-->
    <div class="theStarRating" id="" tabindex="-1" role="dialog" aria-hidden="false">
        <div class="dialog">
            <div class="content">
                <div class="modal-body">
                        <style>
                            ...
                            .starRating:not(old) > label{
                                ...
                                float           : right;
                                position        : relative;
                                background      : url('<?php echo $webPath2;?>img/star-off.svg');
                            ...
                            .starRating:not(old) > label:before{
                                ...
                                width           : 2em;
                                height          : 2em;
                                background      : url('<?php echo $webPath2;?>img/star-on-red.png');
                                background-size : contain;
                                opacity         : 0;
                        ...
                        <h1>How would you rate your service today?</h1>
                        Rating:
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                if(theData.status=='complete'){
                                    ...
                                    location.assign('http://www.mufflerandgo.com');
                                }else{
